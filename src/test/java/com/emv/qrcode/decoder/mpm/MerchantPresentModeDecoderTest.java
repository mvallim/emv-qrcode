...
public class MerchantPresentModeDecoderTest {
  ...
  public void testeSuccessToString() {
    final String encoded = "00020101021229300012D156000000000510A93FO3230Q31280012D15600000001030812345678520441115802CN5914BEST TRANSPORT6007BEIJING64200002ZH0104最佳运输0202北京540523.7253031565502016233030412340603***0708A60086670902ME91320016A011223344998877070812345678";

    final MerchantPresentMode merchantPresentMode = Decoder.decode(encoded, MerchantPresentMode.class);

    assertThat(merchantPresentMode.toString().length(), equalTo(248));
    assertThat(merchantPresentMode.toString(), equalTo("00020101021229300012D156000000000510A93FO3230Q31280012D15600000001030812345678520441115303156540523.725502015802CN5914BEST TRANSPORT6007BEIJING6233030412340603***0708A60086670902ME64200002ZH0104最佳运输0202北京91320016A01122334499887707081234567863047D4F"));
  }
